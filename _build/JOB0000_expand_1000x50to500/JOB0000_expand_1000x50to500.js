...
(lib.JOB0000_expand_1000x50to500 = function(mode,startPosition,loop) {
	...
	this.shape_1.graphics.f("#000099").s().p("");
	this.shape_1.setTransform(731.3,24.8);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000099").s().p("AAOAnIAAgtQAAgIgDgDIgEgDIgFgBQgEAAgDADQgEACgCAFIgCAKIAAAJIAAAfIgSAAIAAhLIAPAAIABAKIAEgFIAGgEQAFgDAHAAQAFAAAFACQAFACADAEQAEAEABAFQACAFAAAFIAAAyg");
	this.shape_2.setTransform(723.2,26.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000099").s().p("");
	this.shape_3.setTransform(715,26.2);

	this.shape_4 = new cjs.Shape();
	this.shape_4.graphics.f("#000099").s().p("");
	...
	this.shape_6.graphics.f("#000099").s().p("");
	this.shape_6.setTransform(691.2,26.2);

	this.shape_7 = new cjs.Shape();
	this.shape_7.graphics.f("#000099").s().p("");
	this.shape_7.setTransform(680.1,26.2);

	this.shape_8 = new cjs.Shape();
	this.shape_8.graphics.f("#000099").s().p("AABAwQgDgBgDgDQgDgDgCgEQgBgEAAgGIAAglIgOAAIAAgPIAOAAIAAgTIARgFIAAAYIATAAIAAAPIgTAAIAAAjQAAAEACACQACACAEABIAMgBIAAAPQgIACgHAAQgGAAgEgCg");
	...
	this.shape_10.graphics.f("#000099").s().p("");
	...
	this.shape_12.graphics.f("#000099").s().p("AgBAzQgEAAgCgDQgDgDgCgDQgBgEAAgGIAAhUIARAAIAABSIABAFQACACAEAAIADAAIAAAPIgIABQgEAAgDgCg");
	this.shape_12.setTransform(645.9,24.8);

	this.shape_13 = new cjs.Shape();
	this.shape_13.graphics.f("#000099").s().p("");
